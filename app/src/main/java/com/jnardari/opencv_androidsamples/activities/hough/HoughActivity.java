package com.jnardari.opencv_androidsamples.activities.hough;
...
import com.jnardari.opencv_androidsamples.activities.hough.line.HoughLine;
import com.jnardari.opencv_androidsamples.activities.hough.line.Line;
//import com.jnardari.opencv_androidsamples.activities.hough.pref.PreferencesActivity;
import com.jnardari.opencv_androidsamples.activities.hough.transform.HoughCircles2D;
import com.jnardari.opencv_androidsamples.activities.hough.transform.HoughCircles3D;
import com.jnardari.opencv_androidsamples.activities.hough.transform.HoughLineTransform;
import com.jnardari.opencv_androidsamples.activities.hough.transform.HoughLines;
...
public class HoughActivity extends AppCompatActivity implements CvCameraViewListener2 {
    ...
    private MenuItem mItemPreviewOPENCV_LINES;
    private MenuItem mItemPreviewOPENCV_LINES_SEGMENTS;
    private MenuItem mItemPreviewJAVA_LINES_OPTIMIZED;
    private MenuItem mItemPreviewJAVA_LINES_NATIVE;
    private MenuItem mItemPreviewOPENCV_CIRCLES;
    private MenuItem mItemPreviewJAVA_CIRCLES_NATIVE;
    private MenuItem mItemPreviewOPENCV_LINES_HORIZON;
    ...
    */
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mItemPreviewSEGMENT = menu.add("Segment");
        mItemPreviewOPENCV_LINES = menu.add("OpenCv_Lines");
        mItemPreviewOPENCV_LINES_SEGMENTS = menu.add("OpenCv_Lines_Seg");
        mItemPreviewJAVA_LINES_OPTIMIZED = menu.add("Java_Lines_Opt");
        mItemPreviewJAVA_LINES_NATIVE  = menu.add("Java_Lines_Native");
        mItemPreviewOPENCV_CIRCLES  = menu.add("OpenCv_Circles");
        mItemPreviewJAVA_CIRCLES_NATIVE = menu.add("Java_Circles_Native");
        mItemPreviewOPENCV_LINES_HORIZON = menu.add("OpenCv_Lines_Horizon");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item == mItemPreviewGRAY)
            ...
            viewMode = VIEW_MODE_SEGMENT;
        else if (item == mItemPreviewOPENCV_LINES)
            viewMode = VIEW_MODE_OPENCV_LINES;
        else if (item == mItemPreviewOPENCV_LINES_SEGMENTS)
            viewMode = VIEW_MODE_OPENCV_LINE_SEGMENTS;
        else if (item == mItemPreviewJAVA_LINES_OPTIMIZED)
            viewMode = VIEW_MODE_JAVA_LINES_OPTIMIZED;
        else if (item == mItemPreviewJAVA_LINES_NATIVE)
            viewMode = VIEW_MODE_JAVA_LINES_NAIVE;
        else if (item == mItemPreviewOPENCV_CIRCLES)
            viewMode = VIEW_MODE_OPENCV_CIRCLES;
        else if (item == mItemPreviewJAVA_CIRCLES_NATIVE)
            viewMode = VIEW_MODE_JAVA_CIRCLES_NAIVE;
        else if (item == mItemPreviewOPENCV_LINES_HORIZON)
            viewMode = VIEW_MODE_OPENCV_LINES_HORIZON;
